    ...
    return (
        <div className='addproduct'>
            ...
            <div className="addproduct-price-row">
                <div className="addproduct-itemfield">
                    <p>Old Price</p>
                    <input value={productDetails.old_price} onChange={changeHandler} type="text" name="old_price" placeholder='Old price here...' />
                </div>
                <div className="addproduct-itemfield">
                    <p>New Price</p>
                    <input value={productDetails.new_price} onChange={changeHandler} type="text" name="new_price" placeholder='New price here...' />
                </div>
            </div>
            <div className="addproduct-itemfield">
